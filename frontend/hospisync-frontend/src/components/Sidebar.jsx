...
const ICONS = {
  ...
  bed: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 14V6a1 1 0 011-1h3v3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M2 10.5h13a1 1 0 011 1V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M2 14v1.5M16 14v1.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="6" cy="7.5" r="1.2" stroke="currentColor" strokeWidth="1.3" />
    </svg>
  ),
  user: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  users: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      <path d="M1.5 15c0-2.5 2.2-4 5-4s5 1.5 5 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M11.5 4.2a2.5 2.5 0 010 4.6M13.5 15c0-2.1-1.3-3.5-3-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  calendar: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
  ...
  pulse: (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 9h3l1.5-4L9 13l1.5-4H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
};
